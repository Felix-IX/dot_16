...
pub fn preprocess_pico8_lua_bytes(input: &Vec<u8>, preprocessor_path: &str)
...
mod tests {
    ...
    fn test_preprocess_pico8_lua_bytes() {
        ...
        let result = preprocess_pico8_lua_bytes(&ori_code, "pico8_patcher/pico8-to-lua.lua").unwrap();
